    ...
    return (
        <div className="relative flex flex-col md:flex-row md:gap-12 group">
            ...
            <div className="ml-8 md:ml-0 flex-1 pb-8">
                <div className="md:hidden text-gray-500 font-mono text-sm mb-2 pt-1">
                    {year}
                </div>
    ...
    const items = [
        {
            ...
            company: "Towalk",
            link: "https://www.linkedin.com/company/agenciatowalk",
        },
        {
            year: "2025",
            title: "Produtor de vídeo",
            company: "Portal ON",
            link: "https://www.linkedin.com/company/portal-on/",
        },
        {
            year: "2025",
        ...
        },
        {
            ...
            link: "https://www.linkedin.com/company/chargemkt",
        },
        {
            year: "2022 - 2023",
            title: "Estagiário em Desenvolvimento de Aplicações Web",
            company: "Coding Invest",
            link: "https://www.linkedin.com/company/coding-invest/",
        },
        {
            year: "2022",
        ...
        <div className="mt-12 md:mt-24">
            <div className="text-center mb-16">
                ...
                <p className="text-gray-400">
                    Um resumo da minha vida profissional e acadêmica.
                </p>
            </div>
